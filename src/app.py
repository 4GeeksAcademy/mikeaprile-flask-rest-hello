...
def handle_user(id_user):
    ...
    if request.method == 'PUT':
        ...
        db.session.commit()
        results['user'] = user.serialize()
        response_body['message'] = 'User modified'
        response_body['results'] = results
        return response_body, 200
...
def handle_characters():
    if request.method == 'GET':
        ...
        response_body['message'] = 'Characters'
        response_body['results'] = results
        return response_body, 200
    if request.method == 'POST':
        response_body = {}
...
def handle_favourite_planets():
    if request.method == 'GET':
        ...
        response_body['message'] = 'Favourite Planets'
        response_body['results'] = results
        return response_body, 200
...
def handle_favourite_planets_byuser(user_id, planet_id):
    if request.method == 'POST':
        ...
        db.session.commit()
        response_body['message'] = 'Favourite Planets added'
    ...
    if request.method == 'DELETE':
        ...
        if not planet:
            response_body['message'] = 'Favourite Planets not found'
            return response_body, 400
        db.session.delete(planet)
        db.session.commit()
        response_body['message'] = 'Favourite Planets deleted'
        return response_body, 200
...
def handle_favourite_characters():
    ...
    response_body['message'] = 'Favourite Characters'
    response_body['results'] = results
    return response_body, 200
...
def handle_favourite_character_byuser(user_id, character_id):
    if request.method == 'POST':
        ...
        db.session.commit()
        response_body['message'] = 'Favourite Characters added'
    ...
    if request.method == 'DELETE':
        ...
        if not character:
            response_body['message'] = 'Favourite Characters not found'
            return response_body, 400
        db.session.delete(character)
        db.session.commit()
        response_body['message'] = 'Favourite Characters deleted'
        return response_body, 200
